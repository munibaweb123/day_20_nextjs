...
export default function NotesApp() {
  ...
  return (
    <div className="flex flex-col h-screen bg-background text-pink-900  bg-pink-100">
      <header className="bg-pink-900 p-4 shadow w-full text-center text-white">
      ...
      <main className="flex-1 overflow-auto p-4">
        <div className="mb-4 ">
          ...
          {editingNoteId === null ? (
            <Button onClick={handleAddNote} className="mt-2 bg-pink-900">
              Add Note
            </Button>
          ) : (
            <Button onClick={handleUpdateNote} className="mt-2 bg-pink-900">
              Update Note
            </Button>
          )}
        </div>
          ...
          {notes.map((note) => (
            <Card key={note.id} className="p-4">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-medium text-pink-900">{note.title}</h2>
                <div className="flex gap-2">
                  ...
                  >
                    <FilePenIcon className="h-4 w-4 text-pink-900" />
                  </Button>
                  <Button
                    variant="ghost"
                    size="icon"
                  ...
                  >
                    <TrashIcon className="h-4 w-4 text-pink-900" />
                  </Button>
                </div>
              </div>
